...
function normalize(saved, defaults) {
  ...
  if (!saved.navigation) return { ...defaults, profile: { ...defaults.profile, ...saved }, theme: { ...defaults.theme, accent: saved.accent || defaults.theme.accent }, sectionVisibility: { ...defaults.sectionVisibility } };
